...
export default function BuilderDatePicker({ value, onChange, minDate, maxDate, placeholder = "Select date" }) {
    const [portalContainer, setPortalContainer] = useState(null);

    const handleChange = (date) => {
        if (date) {
            // Format as YYYY-MM-DD for standard HTML date input compatibility if needed, 
            // but FieldConfigEditor expects YYYY-MM-DD string usually.
            // Let's return the ISO string or formatted string.
            // The native input used e.target.value which is YYYY-MM-DD.
            // So we should return YYYY-MM-DD string.
